...
def process_log_file(cur, filepath):
    ...
    # convert gender and level to dummies, I write them to the db as a boolean type since these are binary variables in our dataset
    ...
    time_data = list(pd.concat([t.dt.time, t.dt.hour, t.dt.day,t.dt.weekofyear, t.dt.month, t.dt.year, t.dt.weekday], axis=1).values)
